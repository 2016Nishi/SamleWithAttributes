...
app.post('/users', function(req, res) {
	...
	var attrReqs = req.body.attrReqs;
	logger.debug('End point : /users');
	logger.debug('User name : ' + username);
	logger.debug('Org name  : ' + orgName);
	logger.debug('Attribute Register: ' + attrs);
	logger.debug('Attribute Request Enroll: ' + attrReqs);
	if (!username) {
	...
	/*if (!attrReqs) {
		res.json(getErrorMessage('\'attrReqs\''));
		return;
	}
	if (!attrs) {
	...
	helper.getRegisteredUsers(username, orgName, attrs, attrReqs, true).then(function(response) {
